...
public class TeacherServiceImpl implements TeacherService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		// Spring Security's User class requires a username, password, and a collection of authorities. We can use the teacher's email as the username for authentication purposes, and we need to convert our Role objects to SimpleGrantedAuthority objects for Spring Security to understand the user's authorities.
